...
import { ArrowLeft, Share2, Download, Search, RefreshCw, AlertTriangle } from "lucide-react";
      ...
      <div className="border-b border-amber-500/20 bg-amber-500/5 px-4 py-2">
        <div className="max-w-5xl mx-auto flex items-center gap-2">
          ...
          <p className="text-xs font-mono text-amber-400/80">
            <span className="font-semibold">Phase 1 Preview:</span> This report uses realistic sample data to demonstrate all sections. Live API integration coming in Phase 2.
          </p>
        </div>
      </div>
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 space-y-12">
        ...
        <div className="border-t border-border/50 pt-8 pb-4 text-center">
          <p className="text-xs font-mono text-muted-foreground">
            Report generated by OnChain Detective · {new Date().toISOString().split("T")[0]} · 
